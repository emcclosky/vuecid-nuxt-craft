...
export default function generateMetaInfo({
  ...
  console.log('!siteSettings.global: ', !siteSettings.global)
  ...
  if (
    ...
    console.warn('siteSettings and siteSettings.global.meta_global_site_settings are required') // prettier-ignore
  }
  ...
  const canonicalUrl = removeTrailingSlash(
    `${verifyTrailingSlash('meta-web-url')}${removeLeadingSlash('pfad')}`
  )
